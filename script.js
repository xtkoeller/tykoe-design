...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (projectGrid) {
        ...
        PROJECTS.forEach(project => {
            ...
            card.innerHTML = `
                <div class="kinetic-inner group/card w-full h-full opacity-0 md:hover:!opacity-100 md:group-hover/grid:opacity-60 md:group-hover/grid:grayscale-[50%] md:hover:!grayscale-0 transition-opacity duration-[280ms] ease-out relative z-10 hover:z-50">
